...
//	double delta = 0.05 ;
	...
	double sigma = 0.05;
	double maxrange = 10; /* 控制了 registerScan 中的  m_laserMaxRange 值 */
	double maxUrange = 50.;
	double regscore = 1e4;
	double lstep = .05;
	double astep = .05;
	...
	OrientedPoint initialPose(-0.000602, 0.012727, -1.570796);
